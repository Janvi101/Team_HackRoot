...
6. **Trend Intelligence** - Analyze historical data for price volatility and peak selling days
...
- 📉 **Price Alerts** - Warnings for dropping prices (volatility detection)
- 📅 **Trend Analysis** - insights on the best days to sell based on history
- 🎯 **Smart Recommendations** with actionable insights
- 🗣️ **Regional Language Support** - Full Hindi & English support with dynamic translations
- 📱 **Responsive Design** works on desktop, tablet, and mobile

### Localization & Map Intelligence

- 🇮🇳 **Hindi Language Support** - Complete UI translation including dynamic data (crops, mandates, trends)
- 🗺️ **Smart Map Switching**:
  - **English Mode**: Uses **CartoDB Voyager** tiles to ensure all place names are in English (no local scripts)
  - **Hindi Mode**: Switch to **Google Maps** tiles for accurate Hindi place names
- 🔄 **Dynamic Content** - Backend data (like "Mandi usually peaks on Mondays") is automatically translated on the frontend
...
- **CartoDB Voyager** - English-optimized map tiles
...
5. Decision engine selects mandi with MAXIMUM net profit
   - Checks for price volatility (3-day drop alert)
   - Identifies historical peak days
   ↓
...
- ✅ **Multi-Language** - Support for regional languages (Hindi implemented)
